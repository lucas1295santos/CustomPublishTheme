            ...
            .forEach(items) { item in
                .li(.article(
                    .div(.style("float: left; width: 100%; height: 100%"),
                        .div(.style("position: relative; width:50%; height: 100%; background-color:blue; float: left;"),
                            .h1(.a(
                                .href(item.path),
                                .text(item.title)
                            )),
                        ...
                        .div(.style("position: relative; width:50%; height: 100%; background-color:red; float: right;"),
                             .img(
                                .class("bla"),
